#line 1 "/Users/ash/Desktop/ash/reverse/WeChat_Test/WeChat_TestDylib/src/Tweak.xm"
...
@class MMTableViewSectionInfo; @class ContactInfoViewController; @class CMessageWrap; @class WCRedEnvelopesLogicMgr; @class CContactMgr; @class WCBizUtil; @class NewSettingViewController; @class CMessageMgr; @class MicroMessengerAppDelegate; @class MMServiceCenter; @class MMTableViewCellInfo; 
...
#line 9 "/Users/ash/Desktop/ash/reverse/WeChat_Test/WeChat_TestDylib/src/Tweak.xm"
...
static void _logos_method$_ungrouped$NewSettingViewController$reloadTableData(_LOGOS_SELF_TYPE_NORMAL NewSettingViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
	...
	MMTableViewCellInfo *followOfficalAccountCell = [_logos_static_class_lookup$MMTableViewCellInfo() normalCellForSel:@selector(followMyOfficalAccount) target:self title:@"关注我的公众号" rightValue:rightValue accessoryType:1];
